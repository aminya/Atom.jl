function _precompile_()
    ...
    isdefined(Atom, Symbol("##fixpath#148")) && precompile(Tuple{getfield(Atom, Symbol("##fixpath#148")),String,String,typeof(Atom.fixpath),String})
    isdefined(Atom, Symbol("#107#108")) && precompile(Tuple{getfield(Atom, Symbol("#107#108")),Text{String}})
    isdefined(Atom, Symbol("#138#141")) && precompile(Tuple{getfield(Atom, Symbol("#138#141")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#140#143")) && precompile(Tuple{getfield(Atom, Symbol("#140#143")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#165#169")) && precompile(Tuple{getfield(Atom, Symbol("#165#169"))})
    isdefined(Atom, Symbol("#175#179")) && precompile(Tuple{getfield(Atom, Symbol("#175#179"))})
    isdefined(Atom, Symbol("#187#191")) && precompile(Tuple{getfield(Atom, Symbol("#187#191"))})
    isdefined(Atom, Symbol("#194#195")) && precompile(Tuple{getfield(Atom, Symbol("#194#195")),Base.MethodList})
    isdefined(Atom, Symbol("#194#195")) && precompile(Tuple{getfield(Atom, Symbol("#194#195")),MD})
    isdefined(Atom, Symbol("#256#258")) && precompile(Tuple{getfield(Atom, Symbol("#256#258")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#257#259")) && precompile(Tuple{getfield(Atom, Symbol("#257#259")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#260#262")) && precompile(Tuple{getfield(Atom, Symbol("#260#262")),Atom.GotoItem})
    isdefined(Atom, Symbol("#27#28")) && precompile(Tuple{getfield(Atom, Symbol("#27#28"))})
    isdefined(Atom, Symbol("#282#284")) && precompile(Tuple{getfield(Atom, Symbol("#282#284")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#283#285")) && precompile(Tuple{getfield(Atom, Symbol("#283#285")),Dict{Symbol,Any}})
    isdefined(Atom, Symbol("#31#32")) && precompile(Tuple{getfield(Atom, Symbol("#31#32")),String})
    isdefined(Atom, Symbol("#33#34")) && precompile(Tuple{getfield(Atom, Symbol("#33#34")),String})
    isdefined(Atom, Symbol("#43#44")) && precompile(Tuple{getfield(Atom, Symbol("#43#44")),String})
    isdefined(Atom, Symbol("#99#100")) && precompile(Tuple{getfield(Atom, Symbol("#99#100")),Hiccup.Node{:table}})
    isdefined(Atom, Symbol("#99#100")) && precompile(Tuple{getfield(Atom, Symbol("#99#100")),Juno.Model})
    ...
    precompile(Tuple{typeof(Atom.localcompletion),Dict{Symbol,Any}})
    ...
    precompile(Tuple{typeof(Atom.shortstr),Type})
    ...
    precompile(Tuple{typeof(Atom.wsicon),Module,Symbol,Complex{Bool}})
    ...
    precompile(Tuple{typeof(Atom.wsicon),Module,Symbol,Irrational{:π}})
    precompile(Tuple{typeof(Atom.wsicon),Module,Symbol,Irrational{:ℯ}})
    ...
    precompile(Tuple{typeof(Base._similar_for),Array{Any,1},Type{Dict{Symbol,String}},Base.Generator{Array{Any,1},typeof(Atom.localcompletion)},Base.HasShape{1}})
    ...
    precompile(Tuple{typeof(Base.collect_to_with_first!),Array{Dict{Symbol,String},1},Dict{Symbol,String},Base.Generator{Array{Any,1},typeof(Atom.localcompletion)},Int64})
